...
export const AuthenticatedApp = () => {
  ...
  return (
    <Container>
      <PageHeader onProjectModalOpen={setProjectModalOpen} />
      <Main>
        <Router>
          <Routes>
            <Route
              path={"/projects"}
              element={
                <ProjectListScreen onProjectModalOpen={setProjectModalOpen} />
              }
            />
            <Route
  ...
  return (
    <Header between>
      <HeaderLeft gap>
        ...
        <ProjectPopover onProjectModalOpen={props.onProjectModalOpen} />
        <span>用户</span>
      </HeaderLeft>
      <HeaderRight>
        <User />
